...
describe('Immediate Execution -', function () {
    ...
    it('Aggregate() - Default Value [String]', function () {
        chai_1.assert.equal("123", Linq.From([1, 2, 3]).Aggregate("", (c, n) => c.toString() + n.toString()));
    });
    // All
    ...
    it('Average()', function () {
        const expectedAvg = data_1.jsn.reduce((sum, o) => sum + o.id, 0) / data_1.jsn.length;
        chai_1.assert.equal(Linq.From(data_1.jsn).Average(o => o.id), expectedAvg);
    });
    // Contains
    ...
    it('Min() - No predicate', function () {
        chai_1.assert.equal(Math.min(...data_1.randomArray), Linq.From(data_1.randomArray).Min());
    });
    it('Min()', function () {
        chai_1.assert.equal(Math.min(...data_1.jsn.map(o => o.id)), Linq.From(data_1.jsn).Min(o => o.id));
    });
