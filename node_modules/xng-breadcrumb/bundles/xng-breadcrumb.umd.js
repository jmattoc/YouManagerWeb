    ...
    ***************************************************************************** */
    ...
    var BreadcrumbService = /** @class */ (function () {
        ...
        BreadcrumbService.prototype.detectRouteChanges = function () {
            ...
            this.router.events
                .pipe(operators.filter(function (event) { return event instanceof i1.GuardsCheckEnd; }))
                ...
                if (event instanceof i1.GuardsCheckEnd && event.shouldActivate) {
                    _this.setupBreadcrumbs(event.state.root);
                }
            });
        };
        BreadcrumbService.prototype.setupBreadcrumbs = function (activatedRouteSnapshot) {
            this.previousBreadcrumbs = this.currentBreadcrumbs;
            // breadcrumb label for base OR root path. Usually, this can be set as 'Home'
            var rootBreadcrumb = this.getRootBreadcrumb();
        ...
        BreadcrumbService.prototype.prepareBreadcrumbItem = function (activatedRouteSnapshot, routeLinkPrefix) {
            var _b = this.parseRouteData(activatedRouteSnapshot.routeConfig), path = _b.path, breadcrumb = _b.breadcrumb;
            var resolvedSegment = this.resolvePathSegment(path, activatedRouteSnapshot);
            ...
            return Object.assign(Object.assign(Object.assign(Object.assign({}, storeItem), breadcrumb), { label: isAutoGeneratedLabel ? autoGeneratedLabel : label, routeLink: routeLink, isAutoGeneratedLabel: isAutoGeneratedLabel }), this.getQueryParamsFromPreviousList(routeLink));
        };
        BreadcrumbService.prototype.prepareBreadcrumbList = function (activatedRouteSnapshot, routeLinkPrefix) {
            var _a;
            if ((_a = activatedRouteSnapshot.routeConfig) === null || _a === void 0 ? void 0 : _a.path) {
                var breadcrumbItem = this.prepareBreadcrumbItem(activatedRouteSnapshot, routeLinkPrefix);
         ...
         */
        BreadcrumbService.prototype.resolvePathSegment = function (segment, activatedRouteSnapshot) {
            ...
            if (segment.includes(PATH_PARAM.PREFIX)) {
                Object.entries(activatedRouteSnapshot.params).forEach(function (_b) {
         ...
         */
        BreadcrumbService.prototype.setQueryParamsForActiveBreadcrumb = function (lastItem, activatedRouteSnapshot) {
            if (lastItem) {
                var queryParams = activatedRouteSnapshot.queryParams, fragment = activatedRouteSnapshot.fragment;
        ...
        BreadcrumbService.prototype.set = function (key, breadcrumb) {
            ...
            this.updateStore.apply(this, __spreadArray([], __read(updateArgs)));
            this.updateCurrentBreadcrumbs.apply(this, __spreadArray([], __read(updateArgs)));
        };
        /**
        ...
        BreadcrumbService.prototype.updateCurrentBreadcrumbs = function (key, breadcrumb) {
            ...
            if (itemIndex > -1) {
                ...
                var breadcrumbsToShow = this.currentBreadcrumbs.filter(function (item) { return !item.skip; });
                this.breadcrumbs.next(__spreadArray([], __read(breadcrumbsToShow)));
            }
        };
        /**
    ...
    BreadcrumbService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function BreadcrumbService_Factory() { return new BreadcrumbService(i0__namespace.ɵɵinject(i1__namespace.ActivatedRoute), i0__namespace.ɵɵinject(i1__namespace.Router)); }, token: BreadcrumbService, providedIn: "root" });
    ...
    var BreadcrumbComponent = /** @class */ (function () {
        function BreadcrumbComponent(breadcrumbService, activateRoute) {
            var _this = this;
            ...
            activateRoute.params.subscribe(function (params) {
                _this.setupComponent(params['someParam']);
            });
        }
        ...
        BreadcrumbComponent.prototype.setupComponent = function (someParam) {
