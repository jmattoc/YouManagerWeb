...
@NgModule({
  ...
  bootstrap: [FormContraComponent,BandejaobjetivoComponent,NewobjetivoComponent,BandejaperiodoComponent,
    NewperiodoComponent,BandejanivelComponent,NewnivelComponent,BandejaobjcumplimientoComponent,NewobjetivocumlimientoComponent,ImphistorialAusenciaComponent
    ],
  providers: [
    DatePipe,
