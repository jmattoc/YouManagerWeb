...
@Component({
  selector: 'app-modalidadtrabajo',
  templateUrl: './modalidadtrabajo.component.html',
  styleUrls: []
})
export class ModalidadtrabajoComponent implements OnInit {
  ...
  public fechainicio: string = '2022-10-20T00:00:00.342Z';
  ...
  listarestadonewcategoria(id=31){
    this.adminservice.getlistarestadocategoria(id).subscribe((res: any) => {
      ...
      //console.log('Estdo-Modtrabajador', this.lstEstadonewcatgoria);
    });
  }
