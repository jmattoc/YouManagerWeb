...
@Component({
  selector: 'app-dialog-modaldevoluciones',
  templateUrl: './dialog-modaldevoluciones.component.html',
  styleUrls: []
})
export class DialogModaldevolucionesComponent implements OnInit {
  ...
  constructor(
    public dialogo: MatDialogRef<DialogModaldevolucionesComponent>,
  ...
  devolver(){
    ...
    this.AssetService.getdevolveractivomodal(this.data.idactivo,this.data.idempleado).subscribe((res: any) => {
      this.bootstrapNotifyBarService.notifySuccess('Se Devolvio correctamente el Activo.');
